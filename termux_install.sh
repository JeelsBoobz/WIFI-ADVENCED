...
# Cyber7F BD WiFi Hacker - Termux Installation Script
# Author: Cyber7F_BD/R2BRAHUL
...
echo ""
echo "╔═══════════════════════════════════════════════════════════════╗"
echo "║              🛡️  Cyber7F BD WiFi Hacker Installer       ║"
echo "║                    Advanced Auto System v2.0                 ║"
echo "╠═══════════════════════════════════════════════════════════════╣"
echo "║  Author: Cyber7F BD/                                    .           ║"
echo "║  Telegram: https://t.me/R2BRAHUL                     , ║"
...
echo -e "${GREEN}🎉 Cyber7F BD WiFi Hacker has been installed successfully!${NC}"
echo ""
...
echo -e "${YELLOW}•${NC} Telegram Channel: ${CYAN}https://t.me/cyber7fbd${NC}"
...
echo -e "${CYAN}Maded ❤️ by Cyber7F BD/R2BRAHUL${NC}"
echo ""
...
if [[ $REPLY =~ ^[Yy]$ ]]; then
    ...
    am start -a android.intent.action.VIEW -d "https://t.me/cyber7fbd" 2>/dev/null || \
    termux-open-url "https://t.me/cyber7fbd" 2>/dev/null || \
    echo -e "${YELLOW}[*]${NC} Please open: https://t.me/cyber7fbd"
fi
